...
@Dependent
public class ReassignmentsEditorFieldInitializer implements FieldInitializer<ReassignmentsEditorFieldDefinition> {

    @Override
    public boolean supports(FieldDefinition fieldDefinition) {
        return fieldDefinition instanceof ReassignmentsEditorFieldDefinition;
    }
