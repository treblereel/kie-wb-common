...
@Dependent
public class NotificationsEditorFieldInitializer implements FieldInitializer<NotificationsEditorFieldDefinition> {

    @Override
    public boolean supports(FieldDefinition fieldDefinition) {
        return fieldDefinition instanceof NotificationsEditorFieldDefinition;
    }
