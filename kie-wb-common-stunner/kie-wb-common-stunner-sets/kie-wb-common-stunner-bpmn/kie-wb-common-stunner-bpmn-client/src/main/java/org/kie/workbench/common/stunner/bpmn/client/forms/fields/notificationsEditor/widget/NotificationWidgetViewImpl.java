...
public class NotificationWidgetViewImpl extends Composite implements NotificationWidgetView {
    ...
    @DataField
    @Inject
    private org.jboss.errai.common.client.dom.Button closeButton, addButton, saveButton;
    ...
    public void init(final NotificationWidgetView.Presenter presenter, List<NotificationRow> rows) {
        ...
        this.dataProvider = new ListDataProvider<>(rows);
        ...
        closeButton.setName(StunnerFormsClientFieldsConstants.INSTANCE.Cancel());
        saveButton.setName(StunnerFormsClientFieldsConstants.INSTANCE.Save());
        addButton.setName(StunnerFormsClientFieldsConstants.INSTANCE.Add());
